        ...
        'messages': {
            ...
            'user': {
                ...
                'donate': {
                    ...
                    'amount': {
                        'insert': "⌨️ Введите сумму пожертвования <span class='tg-spoiler'>(в рублях)</span>:\n\n"\
                            "📌 Для отмены - /cancel",
                        'incorrect_format': "❌ Сумма пожертвования должна быть в виде числа.",
                        'incorrect_quantity': "❌ Сумма пожертвования должна начинаться с {0} рубля.",
                    },
                    'success': "✅ Нажмите на кнопку ниже для подтверждения платежа на сумму <code>{0}</code>₽ или его отмены.",
                },
            },
            'administrator': {
